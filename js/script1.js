function slider(sliderElement) {
  ...
  var init = function () {
    ...
    function reset(){
		document.getElementById("mouseicon").src="Mouse_icon.png";
		p.innerHTML="Scroll to Reveal";
    ...
    window.addEventListener(whatWheel, function (e) {
      ...
      var img = document.getElementById("mouseicon");
      var p = document.getElementById("scroll");
      if(currentSlide==1 && img.src=="Mouse_icon.png" && p.innerHTML=="Scroll to Reveal"){
      	img.src = "down_arrow.png";
      	p.innerHTML = "Find out More!";
      }
	  ...
	  for (var i = 1; i < 7; i++) {
	  document.getElementById("slide1").classList.remove("blur");
	  		if(currentSlide==i){
		  	document.querySelectorAll("span")[i-1].classList.remove("display");
	  }}
    ...
    var animate = function(i){
    		document.querySelectorAll("span")[i-1].classList.add("animation");
    		console.log(i-1);
    }
/*
    document.getElementsByClassName("carousel").addEventListener("slid.bs.carousel", function(){
    	console.log("HURRAY!!!");
    });*/

/*    document.getElementById("down_arrow_button").addEventListener("click", function(){
